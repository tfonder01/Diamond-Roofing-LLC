...
const services = [
  ...
  { number: '04', title: 'Roof repairs', text: 'Careful repairs for leaks, damage, broken shingles, and wear.', image: images.roofRepair },
  { number: '05', title: 'Exterior Remodeling', text: 'Exterior improvements that update the look and condition of your home.', image: images.exterior },
...
export default function Page() {
  ...
  return (
    <main className="site-shell" id="page-top">
      ...
      <footer className="site-footer"><img src={images.logo} alt="Diamond Roofing LLC" /><div><p>Residential roofing, repairs, and remodeling in Clarksville, TN.</p><small>© {new Date().getFullYear()} Diamond Roofing LLC. All rights reserved.</small></div><a className="back-top" href="#page-top">Back to top ↑</a></footer>
    </main>
  )
}
